...
const AdminLayout = () => {
  ...
  const getUserAvatar = (size = 'md') => {
    ...
    // For admin users without photo, show a shield icon avatar
    return (
      <div className={`${sizeClass} rounded-full bg-gradient-to-br from-warning-500 to-warning-600 flex items-center justify-center text-white font-bold`}>
                  ...
                  {adminMenuItems.map((item) => (
                    <Link
                      ...
                      className={`
                        ...
                        ${isActive(item.path)
                          ? 'bg-warning-50 text-warning-600 shadow-soft'
